...
#   filter(include) %>%
#   select(
#     country, country_case, ccode, ccode_case, ccode_ksg, beg, end, tjet_focus,
...
#       filter(country == ctry) %>%
#       mutate(
#         txt_intro = str_replace_all(str_trim(txt_intro), "\n", "\n\n"),
...
# 
# file.copy(
#   from = list.files("~/Dropbox/TJLab/TimoDataWork/country_profiles/original", full.names = TRUE),
