...
df <- TrialsMeasure(cy = df, measure = "trs", type_opts = "int", nexus_vars = c("hrs", "con"), memb_opts = "all", subtype = "icc")
...
df <- TrialsMeasure(cy = df, measure = "trs", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "all") 

df <- TrialsMeasure(cy = df, measure = "trs", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta")
df <- TrialsMeasure(cy = df, measure = "tro", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta")
df <- TrialsMeasure(cy = df, measure = "tfc", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta")
df <- TrialsMeasure(cy = df, measure = "cct", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta")
df <- TrialsMeasure(cy = df, measure = "cce", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta")
df <- TrialsMeasure(cy = df, measure = "crt", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta")
df <- TrialsMeasure(cy = df, measure = "sen", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta")
df <- TrialsMeasure(cy = df, measure = "trs", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "tro", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "tfc", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "cct", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "cce", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "crt", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "sen", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "sta", rank_opts = "hi")

df <- TrialsMeasure(cy = df, measure = "trs", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp")
df <- TrialsMeasure(cy = df, measure = "tro", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp")
df <- TrialsMeasure(cy = df, measure = "tfc", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp")
df <- TrialsMeasure(cy = df, measure = "cct", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp")
df <- TrialsMeasure(cy = df, measure = "cce", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp")
df <- TrialsMeasure(cy = df, measure = "crt", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp")
df <- TrialsMeasure(cy = df, measure = "sen", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp")
df <- TrialsMeasure(cy = df, measure = "trs", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "tro", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "tfc", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "cct", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "cce", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "crt", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp", rank_opts = "hi")
df <- TrialsMeasure(cy = df, measure = "sen", type_opts = "hyb", nexus_vars = c("hrs", "con"), memb_opts = "opp", rank_opts = "hi")

df <- TrialsMeasure(cy = df, measure = "trs", type_opts = "for", nexus_vars = c("hrs", "con"), memb_opts = "all", subtype = "active")
df <- TrialsMeasure(cy = df, measure = "trs", type_opts = "for", nexus_vars = c("hrs", "con"), memb_opts = "all", subtype = "passive")
df <- TrialsMeasure(cy = df, measure = "trs", type_opts = "for", nexus_vars = c("hrs", "con"), memb_opts = "all", subtype = "territorial")
df <- TrialsMeasure(cy = df, measure = "trs", type_opts = "for", nexus_vars = c("hrs", "con"), memb_opts = "all", subtype = "universal")
...
df <- TrialsMeasure(cy = df, measure = "cce", type_opts = c("int", "hyb", "for"), nexus_vars = c("hrs", "con"), memb_opts = "all", hos = TRUE) |> 
  ...
  arrange(country_case, year) %>%
  group_by(country_case) %>%
  fill(hos_cce_int_hyb_for_bincf, 
       .direction = "down") |> 
  mutate(hos_cce_int_hyb_for_bincf = ifelse(is.na(hos_cce_int_hyb_for_bincf), 0, hos_cce_int_hyb_for_bincf))
